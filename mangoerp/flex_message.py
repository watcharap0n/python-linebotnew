...
def flex_profile(imageurl, profile, status):
    flex_message = FlexSendMessage(
        alt_text='Product Mango',
        contents={
            "type": "bubble",
...
def flex_pF(image_url, displayName, status):
    flex_test = FlexSendMessage(
        alt_text='Flex message',
        contents={
  "type": "bubble",
    ...
    "contents": [
      ...
      },
      {
        ...
        "contents": [
          {
            "type": "text",
            "text": "เลือกผลิตภัณฑ์ที่ท่านต้องการได้เลยค่ะ",
            "contents": [
              {
                "type": "span",
                "text": "เลือกผลิตภัณฑ์ที่ต้องการได้เลยค่ะ",
                "style": "normal",
                "weight": "bold",
                "size": "lg",
                "color": "#000000"
          ...
          },
          {
            ...
            "contents": [
              {
                "type": "image",
                "url": "https://sv1.picz.in.th/images/2020/10/22/bfftKJ.jpg",
                "size": "full",
                "aspectMode": "cover",
                "aspectRatio": "3:2",
                "margin": "lg",
