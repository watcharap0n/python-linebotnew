...
<br><br><br>
              ...
              <div id="getDemo" class="tab-pane active">
                ...
                <div class="table-responsive">
                  <table class="table-hover stripe" style="width:100%" id="getdemoTable">
                    ...
                    <tr>
                      <th>
                        <input type="checkbox" name="select" id="select-all-demoz">
                      </th>
                      <th>แท็ก</th>
                      <th>ชื่อ</th>
                      <th>ผลิตภัณฑ์</th>
                        ...
                        <td>
                          <div class="form-group">
                            <input type="checkbox"
                                   ...
                                   id="{{ demo.key }}"
                                   value="{{ demo.key }}"
                                {% if demo.key in data.getDemo.key %}
                                   checked {% endif %}>
                          </div>
                        </td>
                        <td>
  ...
  <script>
      ...
      document.getElementById('select-all-demoz').onclick = function () {
          var checkboxes = document.getElementsByName('key_getDemos');
